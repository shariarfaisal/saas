...
func (q *Queries) CreateRestaurant(ctx context.Context, arg CreateRestaurantParams) (Restaurant, error) {
	row := q.db.QueryRow(ctx, createRestaurant,
		arg.TenantID, arg.HubID, arg.OwnerID, arg.Name, arg.Slug, arg.Type,
		arg.Description, arg.ShortDescription, arg.BannerImageUrl, arg.LogoUrl,
		arg.GalleryUrls, arg.Phone, arg.Email,
		arg.AddressLine1, arg.AddressLine2, arg.Area, arg.City,
		arg.Cuisines, arg.Tags,
		arg.CommissionRate, arg.VatRate, arg.IsVatInclusive,
		arg.MinOrderAmount, arg.AvgPrepTimeMinutes, arg.MaxConcurrentOrders,
		arg.AutoAcceptOrders, arg.OrderPrefix,
		arg.IsAvailable, arg.IsFeatured, arg.IsActive, arg.SortOrder,
	)
	var i Restaurant
	err := row.Scan(
		&i.ID, &i.TenantID, &i.HubID, &i.OwnerID,
		&i.Name, &i.Slug, &i.Type,
		&i.Description, &i.ShortDescription, &i.BannerImageUrl, &i.LogoUrl,
		&i.GalleryUrls, &i.Phone, &i.Email,
		&i.AddressLine1, &i.AddressLine2, &i.Area, &i.City,
		&i.GeoLat, &i.GeoLng,
		&i.Cuisines, &i.Tags,
		&i.CommissionRate, &i.VatRate, &i.IsVatInclusive,
		&i.MinOrderAmount, &i.AvgPrepTimeMinutes, &i.MaxConcurrentOrders,
		&i.AutoAcceptOrders, &i.OrderPrefix, &i.OrderSequence,
		&i.IsAvailable, &i.IsFeatured, &i.IsActive, &i.SortOrder,
		&i.MetaTitle, &i.MetaDescription, &i.MetaKeywords,
		&i.RatingAvg, &i.RatingCount, &i.TotalOrderCount,
...
func (q *Queries) ListAvailableByHubAndArea(ctx context.Context, arg ListAvailableByHubAndAreaParams) ([]Restaurant, error) {
	rows, err := q.db.Query(ctx, listAvailableByHubAndArea, arg.TenantID, arg.Slug, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateRestaurant(ctx context.Context, arg UpdateRestaurantParams) (Restaurant, error) {
	row := q.db.QueryRow(ctx, updateRestaurant,
		arg.Name, arg.Description, arg.ShortDescription, arg.BannerImageUrl, arg.LogoUrl,
		arg.Phone, arg.Email, arg.AddressLine1, arg.Area, arg.City,
		arg.Cuisines, arg.Tags, arg.MinOrderAmount, arg.AvgPrepTimeMinutes,
		arg.AutoAcceptOrders, arg.IsFeatured, arg.SortOrder,
		arg.ID, arg.TenantID,
	)
	var i Restaurant
	err := row.Scan(
...
func (q *Queries) UpsertOperatingHour(ctx context.Context, arg UpsertOperatingHourParams) (RestaurantOperatingHour, error) {
	row := q.db.QueryRow(ctx, upsertOperatingHour,
		arg.RestaurantID, arg.TenantID, arg.DayOfWeek,
		arg.OpenTime, arg.CloseTime, arg.IsClosed,
	)
	var i RestaurantOperatingHour
	err := row.Scan(
		&i.ID, &i.RestaurantID, &i.TenantID,
		&i.DayOfWeek, &i.OpenTime, &i.CloseTime, &i.IsClosed,
	)
	return i, err
}
